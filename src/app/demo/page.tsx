  ...
  return (
    <main className="min-h-screen bg-slate-50 flex items-center justify-center p-5">
      <section className="w-full max-w-xl bg-white rounded-2xl border border-slate-200 shadow-sm p-7 sm:p-10">
        ...
        <p className="text-slate-500 mt-3 leading-relaxed">Este acesso abre as páginas reais do painel, com uma empresa fictícia e respostas de demonstração. O ambiente é reiniciado sempre que você entrar novamente.</p>
