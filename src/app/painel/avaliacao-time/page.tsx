  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-gray-500 text-sm mt-1">Envie o link para os funcionários e acompanhe quem já respondeu.</p>
      </div>
      ...
      {loading ? <div className="flex justify-center py-12"><div className="w-8 h-8 border-4 border-primary-800 border-t-transparent rounded-full animate-spin" /></div> : sectors.length === 0 ? (
        <div className="bg-white border border-gray-100 rounded-2xl p-8 text-center"><p className="text-gray-500">Crie pelo menos um setor em <strong>Dados da Empresa</strong> para gerar o link do time.</p></div>
      ) : (
