...
export const PROGRAMS: { num: number; name: string }[] = [
  ...
  { num: 3,  name: 'Liderança Saudável e Suporte da Equipe' },
  { num: 4,  name: 'Prevenção e Combate ao Assédio' },
  { num: 5,  name: 'Clareza de Papéis, Metas e Expectativas' },
  { num: 6,  name: 'Reconhecimento e Valorização' },
  { num: 7,  name: 'Autonomia e Organização do Trabalho' },
